                        ...
                        <div class="flex items-center justify-end gap-1">
                            ...
                            >
                                <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0zm0 0a3 3 0 000-2.636 4m1.586 4.914a1 1 0 01-.586.282V19a2 2 0 002 2z"/>
                                </svg>
                            </Link>
                            ...
                            >
                                <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 01-2.828 0l-4 4a2 2 0 010 2.828l8 8"/>
                                </svg>
                            </Link>
                            ...
                            >
                                <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-5a2 2 0 00-2-2h12a2 2 0 002 2v12a2 2 0 01-2 2h-5m-4-4h14"/>
                                </svg>
                            </button>
                        </div>
                    </td>
