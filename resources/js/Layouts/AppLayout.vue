...
// =========================================================
// DARK MODE — ikuti sistem OS + bisa di-toggle manual
// =========================================================
...
// SIDEBAR STATE
// =========================================================
const sidebarOpen     = ref(true)   // desktop: expanded/collapsed
const mobileMenuOpen  = ref(false)  // mobile: show/hide
...
// =========================================================
// USER DATA dari Inertia shared props
// =========================================================
...
const navigation = [
    ...
    },
    {
        ...
        children: [
            { name: 'Laba Rugi',  route: 'reports.income' },
            { name: 'Neraca',     route: 'reports.balance' },
            { name: 'Arus Kas',   route: 'reports.cashflow' },
            { name: 'Buku Besar', route: 'reports.ledger' },
        ],
    },
    {
        name: 'Master Data',
        icon: `<path stroke-linecap="round" stroke-linejoin="round"
                     d="M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21
                        3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79
                        8 4m0 5c0 2.21-3.582 4-8 4s-8-1.79-8-4"/>`,
        children: [
            { name: 'Rekening',          route: 'accounts.index' },
            { name: 'Kategori',          route: 'categories.index' },
            { name: 'Chart of Accounts', route: 'coa.index' },
            { name: 'Klien',             route: 'clients.index' },
        ],
    },
]
...
// =========================================================
// DROPDOWN STATE untuk menu dengan children
// =========================================================
...
const isParentActive = (children) => {
    return children?.some(child => {
        try { return route().current(child.route) } catch { return false }
    })
}
...
const notifications = ref([
    // Placeholder — nanti diisi dari API
])
    ...
    <div class="min-h-screen bg-gray-50 dark:bg-gray-950 transition-colors duration-300">
        ...
        <aside
            :class="[
                ...
                // Desktop: expanded atau collapsed
        ...
        >
            ...
            <nav class="flex-1 overflow-y-auto overflow-x-hidden py-4 px-2 space-y-0.5">
                ...
                <template v-for="item in navigation" :key="item.name">
                    ...
                    >
                        ...
                        <div
                            v-if="!sidebarOpen"
                            class="absolute left-full ml-2 px-2 py-1 rounded-md
                    ...
                    <div v-else>
                        ...
                        >
                            <div
                                v-if="openDropdowns[item.name] && sidebarOpen"
            ...
            <div class="shrink-0 border-t border-gray-200 dark:border-gray-800 p-3">
                <div :class="[
                    ...
                    <!-- Avatar -->
                    <div class="h-8 w-8 shrink-0 rounded-full bg-indigo-600
        ...
        >
            ...
            <!-- TOP NAVBAR -->
            <!-- ============================================== -->
            <header class="sticky top-0 z-20 flex h-16 items-center gap-4 px-4
                ...
                <div class="hidden lg:flex flex-1 max-w-md">
                    <div class="relative w-full">
                        ...
                        <kbd class="absolute right-3 top-1/2 -translate-y-1/2
                                    ...
                                    bg-white dark:bg-gray-700 px-1.5 py-0.5
                ...
                <div class="flex items-center gap-2">
                    ...
                    <!-- AI Assistant Button — ditonjolkan -->
                    <Link
                        :href="route('ai.index')"
                    ...
                    >
                        ...
                        <span class="absolute inset-0 bg-gradient-to-r from-white/0
                                     via-white/10 to-white/0 translate-x-[-100%]
                    ...
                    >
                        <!-- Sun icon (dark mode aktif) -->
                        <svg v-if="isDark" class="h-5 w-5" fill="none"
                        ...
                        <!-- Moon icon (light mode aktif) -->
                        <svg v-else class="h-5 w-5" fill="none"
                             viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                            <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="relative notif-btn">
                        ...
                        >
                            ...
                            <span
                                ...
                                class="absolute top-1.5 right-1.5 h-2 w-2
                        ...
                        >
                            ...
                            >
                                ...
                                <div v-if="notifications.length === 0"
                                    ...
                                    <svg class="mx-auto h-8 w-8 text-gray-300 dark:text-gray-600
                                                mb-2" fill="none" viewBox="0 0 24 24"
                                         stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                              stroke-width="1.5"
                                              d="M14.857 17.082a23.848 23.848 0 005.454-1.31A8.967
                                                 8.967 0 0118 9.75v-.7V9A6 6 0 006 9v.75a8.967
                                                 8.967 0 01-2.312 6.022c1.733.64 3.56 1.085 5.455
                                                 1.31m5.714 0a24.255 24.255 0 01-5.714 0m5.714
                                                 0a3 3 0 11-5.714 0"/>
                                    </svg>
                    ...
                    <div class="relative user-btn">
                        ...
                        >
                            <!-- Avatar -->
                            <div class="h-7 w-7 rounded-full bg-indigo-600
                                        flex items-center justify-center
                                        text-white text-xs font-bold shrink-0">
                                {{ user?.name?.charAt(0)?.toUpperCase() ?? 'U' }}
                            </div>
                            <span class="hidden sm:block text-sm font-medium
                                         text-gray-700 dark:text-gray-300 max-w-24 truncate">
                                {{ user?.name }}
                            </span>
                                ...
                                <div class="py-1">
                                    ...
                                    >
                                        <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24"
                                             stroke="currentColor" stroke-width="1.5">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                  d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75
                                                     0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998
                                        ...
                                        <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24"
                                            ...
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                  d="M9.594 3.94c.09-.542.56-.94 1.11-.94h2.593c.55
                                                     ...
                                                     1.075.124l1.217-.456a1.125 1.125 0 011.37.49l1.296
                                                     2.247a1.125 1.125 0 01-.26 1.431l-1.003.827c-.293.24-.438.613-.431.992a6.759
                                                     ...
                                                     1.125 0 01-1.369-.49l-1.297-2.247a1.125 1.125 0 01.26-1.431l1.004-.827c.292-.24.437-.613.43-.992a6.932
