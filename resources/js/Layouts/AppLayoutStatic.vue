...
// =========================================================
// STATIC DATA — ganti dengan data dinamis nanti
// TODO: ganti dengan data dari Inertia shared props
// const user   = computed(() => usePage().props.auth.user)
// const tenant = computed(() => usePage().props.auth.tenant)
// =========================================================
const user = {
    name:  'Erick Prawira',
...
// =========================================================
// DARK MODE — ikuti OS, bisa toggle manual
// =========================================================
...
// =========================================================
// NAVIGATION — semua href="#" dulu, ganti dengan route() nanti
// TODO: ganti href="#" dengan :href="route('nama.route')"
// =========================================================
const navigation = [
    {
        name:   'Dashboard',
...
// =========================================================
// DROPDOWN — untuk Laporan & Master Data
// =========================================================
const openDropdowns = ref({ 'Laporan': false, 'Master Data': false })
                            ...
                            <div v-if="openDropdowns[item.name] && sidebarOpen"
                                ...
                                <a v-for="child in item.children" :key="child.name" :href="child.href"
                                   class="flex items-center gap-2 rounded-lg px-3 py-2 text-sm
                                    ...
                                    <div class="h-1.5 w-1.5 rounded-full bg-gray-300 dark:bg-gray-600 shrink-0"/>
                                    {{ child.name }}
                                </a>
                            </div>
                        </Transition>
                            ...
                            <div v-if="showNotifications"
                                ...
                                <div class="divide-y divide-gray-100 dark:divide-gray-800">
                                    <div class="flex gap-3 px-4 py-3 hover:bg-gray-50
                                        ...
                                        <div class="h-8 w-8 rounded-full bg-green-100 dark:bg-green-900/30
                                    ...
                                    <div class="flex gap-3 px-4 py-3 hover:bg-gray-50
                                                dark:hover:bg-gray-800 cursor-pointer transition">
                                        <div class="h-8 w-8 rounded-full bg-yellow-100 dark:bg-yellow-900/30
                                                    flex items-center justify-center shrink-0">
                                        ...
                                        <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24"
                                            ...
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                  d="M9.594 3.94c.09-.542.56-.94 1.11-.94h2.593c.55
                                                     ...
                                                     2.247a1.125 1.125 0 01-.26 1.431l-1.003.827c-.293
                                                     .24-.438.613-.431.992a6.759 6.759 0 010 .255c-.007
                                                     .378.138.75.43.99l1.005.828c.424.35.534.954.26 1.43
                                                     l-1.298 2.247a1.125 1.125 0 01-1.369.491l-1.217-.456
                                                     c-.355-.133-.75-.072-1.076.124a6.57 6.57 0 01-.22.128
                                                     c-.331.183-.581.495-.644.869l-.213 1.28c-.09.543-.56
                                                     .941-1.11.941h-2.594c-.55 0-1.02-.398-1.11-.94l-.213
                                                     -1.281c-.062-.374-.312-.686-.644-.87a6.52 6.52 0 01
                                                     -.22-.127c-.325-.196-.72-.257-1.076-.124l-1.217.456
                                                     a1.125 1.125 0 01-1.369-.49l-1.297-2.247a1.125 1.125
                                                     0 01.26-1.431l1.004-.827c.292-.24.437-.613.43-.992
                                                     a6.932 6.932 0 010-.255c.007-.378-.138-.75-.43-.99
                                                     l-1.004-.828a1.125 1.125 0 01-.26-1.43l1.297-2.247
                                                     a1.125 1.125 0 011.37-.491l1.216.456c.356.133.751
                                                     .072 1.076-.124.072-.044.146-.087.22-.128.332-.183
